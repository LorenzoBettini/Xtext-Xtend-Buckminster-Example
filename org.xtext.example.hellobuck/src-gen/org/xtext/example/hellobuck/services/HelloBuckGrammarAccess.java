...
package org.xtext.example.hellobuck.services;
...
@Singleton
public class HelloBuckGrammarAccess extends AbstractGrammarElementFinder {
	...
	@Inject
	public HelloBuckGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.xtext.example.hellobuck.HelloBuck".equals(grammar.getName())) {
				return grammar;
			}
