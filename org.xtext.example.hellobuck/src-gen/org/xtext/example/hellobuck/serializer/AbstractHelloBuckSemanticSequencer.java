package org.xtext.example.hellobuck.serializer;
...
public class AbstractHelloBuckSemanticSequencer extends AbstractSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == HelloBuckPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case HelloBuckPackage.GREETING:
				if(context == grammarAccess.getGreetingRule()) {
					sequence_Greeting(context, (Greeting) semanticObject); 
					return; 
				}
				else break;
			case HelloBuckPackage.MODEL:
	...
	protected void sequence_Greeting(EObject context, Greeting semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, HelloBuckPackage.Literals.GREETING__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, HelloBuckPackage.Literals.GREETING__NAME));
		}
